var eventname_desc = {
    ...
    web_design:
        { name: "Web Designing" },
     debate: { name: "Debate" },
     et_quiz: { name: "Entertainment Quiz" 
                },
     photography: { name: "Photography" },
     treasure_hunt: { name: "Treasure Hunt" },
     movie_making: { name: "Movie Making" },
     namma_bhaashe_kannada: { name: "Namma Bhaashe Kannada" },
     gaming: { name: "Gaming" },
     footloose: { name: "FootLoose" },
     buzzinga: { name: "Buzzinga" }
};
